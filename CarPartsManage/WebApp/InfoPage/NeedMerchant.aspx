<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NeedMerchant.aspx.cs" Inherits="WebApp.InfoPage.NeedMerchant" %>
...
<script type="text/javascript">
    function linkToPart(id) {
        window.open('NeedMerchantEdit.aspx?nid=' + id, '_blank', 'width=600,height=400,top=100px');
    }
    $(function () {
        $("#btnAdd").click(function () {
            window.open('NeedMerchantEdit.aspx', '_blank', 'width=600,height=400,top=100px');
        });
    });
    </script>
    <style type="text/css">
...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="gvNeedMer" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" AllowPaging="True" OnPageIndexChanging="gvSupplies_PageIndexChanging">
            <Columns>
